//
// ImageManipulate Service
//

cardApp.service('ImageManipulate', ['$window', function($window) {
    ...
    function DitherFilter() {
        ...
        this.filter = function(input, values) {
            ...
            for (var y = 0; y < height; y++) {
                ...
                for (var x = 0; x < width; x++) {
                    var r1 = inputData[index];
                    var g1 = inputData[index + 1];
                    var b1 = inputData[index + 2];
                    if (!color) {
                    ...
                    outputData[index] = r2;
                    outputData[index + 1] = g2;
                    outputData[index + 2] = b2;
    ...
    function Exposure2Filter() {
        ...
        this.filter = function(input, values) {
            ...
            for (var i = 0; i < 256; i++) {
                //gain
                var g = Math.min(255 * Math.pow(i / 255, 1 / 10) + 0.5, RGBmax);
                var val2 = Math.min(i * Math.pow(1.7, amount), g);
                table[i] = val2;
            }
            filterUtils.tableFilter(inputData, table, width, height);
        };
    ...
    this.brightness = new BrightnessFilter();
    this.bump = new BumpFilter();
    this.circlesmear = new CircleSmearFilter();
    this.contrast = new ContrastFilter();
    this.crosssmear = new CrossSmearFilter();
    this.diffusion = new DiffusionFilter();
    this.dither = new DitherFilter();
    this.edge = new EdgeFilter();
    this.emboss = new EmbossFilter();
    this.exposure = new ExposureFilter();
    this.exposure2 = new Exposure2Filter();
    this.gain = new GainFilter();
    this.gamma = new GammaFilter();
    this.grayscale = new GrayscaleFilter();
    this.hue = new HueFilter();
    this.invert = new InvertFilter();
    this.kaleidoscope = new KaleidoscopeFilter();
    this.lensdistortion = new LensDistortionFilter();
    this.linesmear = new LineSmearFilter();
    this.maximum = new MaximumFilter();
    this.median = new MedianFilter();
    this.minimum = new MinimumFilter();
    this.noise = new NoiseFilter();
    this.oil = new OilFilter();
    this.opacity = new OpacityFilter();
    this.pinch = new PinchFilter();
    this.pixelate = new PixelationFilter();
    this.posterize = new PosterizeFilter();
    this.rgbadjust = new RGBAdjustFilter();
    this.saturation = new SaturationFilter();
    this.sawtoothripple = new SawtoothRippleFilter();
    this.sepia = new SepiaFilter();
    this.sharpen = new SharpenFilter();
    this.sineripple = new SineRippleFilter();
    this.solarize = new SolarizeFilter();
    this.sparkle = new SparkleFilter();
    this.squaresmear = new SquareSmearFilter();
    this.threshold = new ThresholdFilter();
    this.triangleripple = new TriangleRippleFilter();
    this.twirl = new TwirlFilter();
    this.vignette = new VignetteFilter();
    this.waterripple = new WaterRippleFilter();
