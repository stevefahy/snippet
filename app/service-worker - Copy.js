...
if (workbox) {
    ...
    async function updateLatestCard(id, card, conv_type) {
        //console.log(card);
            ...
            return cache.keys().then(function(requests) {
                ...
                return caches.match(found_url).then(async function(cacheResponse) {
                    ...
                    if (cacheResponse) {
                        ...
                        updateFeed(card, 'create_update', conv_type) 
...
console.log('updated');
    ...
    self.addEventListener('message', function(event) {
        ...
        if (event.data.message === "updatelatestcard") {
            updateLatestCard(event.data.object.id, event.data.object.card, event.data.object.conversation_type);
        }
